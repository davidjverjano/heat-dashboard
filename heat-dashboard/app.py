...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div style="text-align:center; opacity:0.7; font-size:0.8rem; margin-top:8px;">
            ...
            <span style="color:#F7B267">2024-25 Season</span>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
st.markdown(
    '<p style="color:#CCC5B9; font-size:1.1rem;">Select a page from the sidebar to explore team and player analytics for the 2024-25 season.</p>',
    unsafe_allow_html=True,
)
...
st.markdown(
    ...
    <div style="color:#CCC5B9; font-size:0.9rem; text-align:center; padding: 20px 0;">
        ...
        Data: Local sample data (2024-25 season)
    </div>
    """,
    unsafe_allow_html=True,
)
